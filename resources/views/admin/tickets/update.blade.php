...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="col-md-12  mt-3 pb-5">
            <form class="mt-3" id="editTicket" data-id="{{ $ticket->id }}"  >
                @csrf
                <div class="row">
                    <div class="form-group col-md-6">
                        <input type="text" name="name" value="{{old('name',$ticket->name)}}" placeholder="Package Name .." class="form-control">
                    </div>

                    <div class="form-group col-md-6">
                        <input type="text" name="phone" value="{{old('phone',$ticket->phone)}}"  placeholder="Phone Number .." class="form-control">
                    </div>
                    <div class="form-group col-md-12">
                        <textarea type="text" name="order" placeholder="Order Details .." class="form-control">{{old('order',$ticket->order)}}</textarea>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $("#editTicket").submit(function (e)
        {
            ...
            let ticket_date= new FormData($("#editTicket")[0])
            var id  = $("#editTicket").data("id");
            let _url = `/Admin/Ticket/edit/${id}`;
